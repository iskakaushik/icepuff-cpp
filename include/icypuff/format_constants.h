...
// Error messages
static constexpr std::string_view ERROR_INVALID_MAGIC =
    "Invalid file: expected magic at offset";
static constexpr std::string_view ERROR_INVALID_FOOTER_SIZE =
    "Invalid footer size";
static constexpr std::string_view ERROR_READER_NOT_INITIALIZED =
    "Reader is not initialized";
static constexpr std::string_view ERROR_INCOMPLETE_BLOB_READ =
    "Failed to read complete blob data";
...
static constexpr int FOOTER_STRUCT_FLAGS_OFFSET =
    FOOTER_STRUCT_PAYLOAD_SIZE_OFFSET + 4;
static constexpr int FOOTER_STRUCT_FLAGS_LENGTH = 4;
static constexpr int FOOTER_STRUCT_MAGIC_OFFSET =
    FOOTER_STRUCT_FLAGS_OFFSET + FOOTER_STRUCT_FLAGS_LENGTH;
static constexpr int FOOTER_STRUCT_LENGTH =
    FOOTER_STRUCT_MAGIC_OFFSET + MAGIC_LENGTH;
...
inline void write_integer_little_endian(uint8_t* data, int offset,
                                        uint32_t value) {
