...
Result<std::unique_ptr<BlobMetadata>> ParseBlobMetadata(
  ...
  params.input_fields =
      json[FileMetadataParser::kFields].get<std::vector<int>>();
  ...
  params.sequence_number =
      json[FileMetadataParser::kSequenceNumber].get<int64_t>();
  ...
  if (json.contains(FileMetadataParser::kCompressionCodec)) {
    ...
    params.compression_codec =
        json[FileMetadataParser::kCompressionCodec].get<std::string>();
  }
  ...
  if (json.contains(FileMetadataParser::kProperties)) {
    ...
    params.properties =
        json[FileMetadataParser::kProperties]
